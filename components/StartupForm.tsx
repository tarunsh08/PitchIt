  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-start gap-3 w-full">
        <label
          htmlFor="title"
          className="font-semibold text-base text-gray-800 flex items-center gap-2"
        >
      ...
      >
        ...
        <div className="w-full border-2 border-gray-200 rounded-xl overflow-hidden focus-within:border-yellow-400 focus-within:ring-2 focus-within:ring-yellow-100 transition-all duration-300">
          <MdEditor
            ...
            textareaProps={{
              placeholder:
                "Describe your idea, the problem it solves, your target market, and what makes it unique...",
            }}
          />
        </div>
        {errors.pitch && (
